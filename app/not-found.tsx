        ...
        <div className="flex-1 flex items-center justify-center overflow-y-auto">
          <div className="max-w-4xl mx-auto text-center px-4">
              ...
              >
                ...
                >
                  <div className="text-9xl font-bold font-plus-jakarta-sans text-gradient mb-4">
                    4🤖4
                  </div>
                  <motion.div
                    className="text-[2rem]"
                ...
                <motion.h1 
                  className="text-[2rem] font-bold font-plus-jakarta-sans text-gray-800 mb-6"
                ...
                >
                  ...
                  <h2 className="text-2xl font-bold font-plus-jakarta-sans text-gray-800 mb-4">

        ...
        <div className="flex">
          ...
          <div className="flex-1 p-6 space-y-6">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-lg font-bold font-plus-jakarta-sans text-gray-900 flex items-center">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {mlModels.map((model: MLModel) => (
                  ...
                  >
                    <h3 className="font-semibold font-plus-jakarta-sans text-gray-900 mb-2">
                      {model.name}
                    </h3>
          ...
          <div className="w-80 p-6">
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300 sticky top-24">
              <h3 className="font-bold font-plus-jakarta-sans text-gray-900 mb-4 flex items-center">

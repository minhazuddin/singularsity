        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold font-plus-jakarta-sans text-gray-900">
                  Settings
                </h1>
          ...
          <div className="lg:col-span-3">
              ...
              >
                ...
                <div className="mt-8 p-6 border border-red-200 rounded-lg bg-red-50">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold font-plus-jakarta-sans text-red-900 mb-2">
                        Delete Account
                      </h3>
                ...
                >
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="text-2xl font-bold font-plus-jakarta-sans text-primary">
                    ...
                    {plans.map((planOption: any, index: number) => (
                      ...
                      >
                        ...
                        <div className="text-center mb-4">
                          ...
                          <div className="text-3xl font-bold font-plus-jakarta-sans text-primary mb-1">
                            ${planOption.price}
                          </div>
            ...
            {activeTab === 'api' && (
              ...
              >
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-md font-semibold font-plus-jakarta-sans text-gray-900">
                      API Keys
                    </h3>
                    <motion.button
                ...
                {/* Rate Limits Section */}
                <div className="mb-8">
                  <h3 className="text-md font-semibold font-plus-jakarta-sans text-gray-900 mb-4">
                    Rate Limits
                  </h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold font-plus-jakarta-sans text-gray-900">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  <motion.h3 
                    ...
                    className={`text-sm font-bold font-plus-jakarta-sans ${

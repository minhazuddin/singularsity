  ...
  return (
    <div className={mainContentClass}>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="space-y-1">
                    <div className="text-2xl font-bold font-plus-jakarta-sans text-gray-900 group-hover:text-primary transition-colors duration-300">
                      {stat.value}
                    </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-bold font-plus-jakarta-sans text-gray-900">
                  Plan Usage
                </h2>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                <span className="text-lg font-bold text-gray-900 font-plus-jakarta-sans">
            ...
            <div className="grid grid-cols-3 gap-4 pt-2">
              <div className="text-center">
                <div className="text-lg font-bold text-gray-900 font-plus-jakarta-sans">
                  {(user.dataGenerated / 1000000).toFixed(1)}M
                </div>
                <div className="text-xs text-gray-600 font-segoe">Used</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-bold text-green-600 font-plus-jakarta-sans">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4 flex-1">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900 font-plus-jakarta-sans text-base group-hover:text-primary transition-colors duration-300">
                        {project.name}
                      </h3>
      ...
      <section className="px-6 pb-6 bg-gradient-to-t from-slate-50 via-blue-50/30 to-purple-50/20 relative overflow-hidden">
        ...
        >
          <div className="mb-4">
            <h2 className="text-lg font-bold font-plus-jakarta-sans text-gray-900 mb-2">
              Quick Actions
            </h2>
            <p className="text-sm text-gray-600 font-segoe">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="font-bold font-plus-jakarta-sans text-lg mb-2">Generate New Data</h3>
            ...
            >
              ...
              >
                ...
                <h3 className="font-bold font-plus-jakarta-sans text-gray-900 text-lg mb-2 group-hover:text-primary transition-colors duration-300">
                  Manage Projects
                </h3>

                      ...
                      <>
                        ...
                        <div className="px-6 py-4 bg-gradient-to-r from-primary/5 to-secondary/5 border-b border-gray-100">
                          <div className="flex items-center">
                            ...
                            <h3 className="font-semibold text-gray-900 font-plus-jakarta-sans">
                              {item.name}
                            </h3>
                          </div>
                        </div>
                                  ...
                                  <div className="relative z-10 flex items-start w-full">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="flex items-center justify-between">
                                        <h4 className="text-sm font-semibold text-gray-900 font-plus-jakarta-sans group-hover:text-primary transition-colors duration-300">
                                          {dropdownItem.name}
                                        </h4>
                  ...
                  >
                    ...
                    <div className="px-6 py-4 bg-gradient-to-r from-primary/5 to-secondary/5 border-b border-gray-100">
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="font-semibold text-gray-900 font-plus-jakarta-sans">
                            {userEmail?.split('@')[0] || 'User'}
                          </div>

    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-semibold font-plus-jakarta-sans mb-6">Services</h3>
          ...
          {/* Solutions */}
          <div>
            <h3 className="text-lg font-semibold font-plus-jakarta-sans mb-6">Solutions</h3>
            <ul className="space-y-3">
              <li>
          ...
          {/* Company */}
          <div>
            <h3 className="text-lg font-semibold font-plus-jakarta-sans mb-6">Company</h3>
            <ul className="space-y-3">
              <li>
